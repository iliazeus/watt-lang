...
export interface IfStatement<M, MM> extends BaseNode<M> {
  type: "IfStatement";
  condition: Expression<MM>;
  thenBody: Statement<MM>;
  elseBody: Statement<MM> | null;
}
...
export interface AssignmentStatement<M, MM> extends BaseNode<M> {
